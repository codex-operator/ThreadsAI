(function (_0x4ed36f, _0x158f1d) {
  ...
  while (true) {
    try {
      const _0x517b4a =
        parseInt(_0x3f9f(0xf1)) / 1 +
        parseInt(_0x3f9f(0xc8)) / 2 +
        (parseInt(_0x3f9f(0xe7)) / 3) * (-parseInt(_0x3f9f(0xce)) / 4) +
        parseInt(_0x3f9f(0xef)) / 5 +
        (parseInt(_0x3f9f(0xd0)) / 6) * (parseInt(_0x3f9f(0xea)) / 7) +
        -parseInt(_0x3f9f(0xdf)) / 8 +
        -parseInt(_0x3f9f(0xe2)) / 9;
...
function normalizeUnit(_0x2519ac) {
  ...
  return _0x2e5f62[_0x3f9f(0xc6)](String, _0x2519ac || "")
    [_0x3f9f(0xed)]()
    .toLowerCase()
    .replace(/\.$/, "");
}
function parseRelativeTime(_0x24e8a0) {
  ...
  const _0x3b91f8 = String(_0x24e8a0 || "")
    [_0x3f9f(0xed)]()
    .toLowerCase();
  if (!_0x3b91f8) {
    return null;
  }
  const _0x9acfa7 = _0x3b91f8[_0x3f9f(0xe1)](
    /(\d+(?:[.,]\d+)?)\s*([a-zа-яё]+)/i,
  );
  if (!_0x9acfa7) {
    return null;
...
export function parseTimeAgoHours(
  _0x20a3f6,
  _0x3c3be3 = Date[_0x3f9f(0xe0)](),
) {
  const _0x1e4c0e = {
  ...
  const _0x496d53 = String(_0x1e4c0e[_0x3f9f(0xee)](_0x20a3f6, ""))[
    _0x3f9f(0xed)
  ]();
  if (!_0x496d53) {
    return Infinity;
  ...
  if (_0x29fe45) {
    if (_0x1e4c0e[_0x3f9f(0xcf)] !== "MpwyC") {
      const _0x5f0212 = new Date(
        _0x1e4c0e[_0x3f9f(0xcb)](Number, _0x29fe45[3]),
        _0x1e4c0e[_0x3f9f(0xe4)](Number(_0x29fe45[2]), 1),
        Number(_0x29fe45[1]),
      );
      return _0x1e4c0e[_0x3f9f(0xda)](
        _0x1e4c0e[_0x3f9f(0xcd)](_0x3c3be3, _0x5f0212.getTime()),
        _0x1e4c0e[_0x3f9f(0xca)](1000, 60) * 60,
      );
    } else {
      return _0x1172b1(_0x2bced3 || "")
        [_0x3f9f(0xed)]()
        .toLowerCase()
        [_0x3f9f(0xde)](/\.$/, "");
    }
...
function _0x3f9f(_0x47b364, _0xf1b1eb) {
  ...
  if (_0x3f9f.SeQvfo === undefined) {
    var _0x3ce658 = function (_0x38cf63) {
      ...
      for (
        let _0x47a39d = 0;
        (_0x50ad1f = _0x38cf63.charAt(_0x47a39d++));
        ~_0x50ad1f &&
        ((_0x308570 = _0x576d50 % 4 ? _0x308570 * 64 + _0x50ad1f : _0x50ad1f),
        _0x576d50++ % 4)
          ? (_0x111289 += String.fromCharCode(
              255 & (_0x308570 >> ((-2 * _0x576d50) & 6)),
            ))
          : 0
      ) {
        _0x50ad1f =
      ...
      let _0xb0f5b6 = 0;
      for (
        let _0x42f452 = _0x111289.length;
        _0xb0f5b6 < _0x42f452;
        _0xb0f5b6++
      ) {
        _0x114493 +=
          "%" + ("00" + _0x111289.charCodeAt(_0xb0f5b6).toString(16)).slice(-2);
      }
...
export function parseTimeAgoDateMs(_0x4efaec, _0x3aad5b = Date.now()) {
  ...
  if (_0x1ea1ac) {
    return new Date(
      _0x1d74a8[_0x3f9f(0xd3)](Number, _0x1ea1ac[3]),
      Number(_0x1ea1ac[2]) - 1,
      Number(_0x1ea1ac[1]),
    )[_0x3f9f(0xd8)]();
  }
  ...
  return _0x1d74a8[_0x3f9f(0xc7)](
    _0x3aad5b,
    Math.round(_0x1d74a8[_0x3f9f(0xd2)](_0x365b81 * 60, 60) * 1000),
  );
}
